...
// Onda animada do topo. É a MESMA do header da loja e do admin (StorefrontFrame)
// e da tela de login: um único componente, para as três ficarem sempre iguais.
// Cores e altura vêm dos tokens --store-wave-* e --storefront-wave-height.
export default function StorefrontWave() {
